...
const Create = (props) => {
  ...
  return (
    <div className='border w-[70%] p-10 text-center'>   
            <h1 className="mb-10  text-4xl text-thin ">Set <span className='text-red-300'>Reminder</span> For Task</h1>
            <br />
            <form onSubmit={SubmitHandler} >
                    ...
                    <button className="text-xl px-10 py-2 border rounded">Create todos</button>
                    <br /><br />
            </form>
    </div>
  )
